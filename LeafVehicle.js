function LeafVehicle(x, y) {
 ...
 this.display = function() {
  ...
  bezierVertex(25 * sin(this.theta), 25 * cos(this.theta), (15 - this.pointShift / 2) * sin(this.theta), (55 + this.pointShift) * cos(this.theta), 5 * sin(this.theta), (55 + this.pointShift) * cos(this.theta));
  bezierVertex(0 * sin(this.theta), (55 + this.pointShift) * cos(this.theta), -10 * sin(this.theta), 25 * cos(this.theta), 10 * sin(this.theta), 15 * cos(this.theta)); // draw the other half of the shape
 ...
 this.applyBehaviors = function(vehicles, desire) {
 ...
 this.cohesion = function(vehicles2) {
  var neighbourist = 10;
  var sum = 0;
  var count = 0;
